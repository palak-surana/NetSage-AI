...
def classify_expected_fault(expected_fault):
    """
    Convert dataset expected_fault into a broad category.

    IMPORTANT:
    Specific categories are checked before generic words.
    """
    ...
    #
    # IMPORTANT:
    # This comes AFTER VLAN because
    # "native vlan" contains "nat".
    # -----------------------------------------------------
    ...
    # DHCP
    #
    # DHCP subnet mask is treated as SUBNET because
    # the checker rule is "Subnet Mask".
    # -----------------------------------------------------
    ...
    #
    # IMPORTANT:
    # Native VLAN must be handled before generic NAT.
    # -----------------------------------------------------
...
def classify_rule(rule_name):
    """
    Convert checker rule name into a broad category.
    """
    ...
    # VLAN
    #
    # MUST COME BEFORE NAT.
    #
    # "Native VLAN" contains the letters "nat".
    # -----------------------------------------------------
