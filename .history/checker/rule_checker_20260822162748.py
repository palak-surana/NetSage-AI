...
def check_gateway(text, findings):
    ...
    # CASE002
    gateway_patterns = [
        r"(?:configured|current)\s+default gateway\s+"
        r"(\d+\.\d+\.\d+\.\d+)"
        r".*?"
        r"(?:expected|correct|actual)\s+"
        r"(?:default gateway|gateway)\s+"
        r"(\d+\.\d+\.\d+\.\d+)",
...
def process_csv(filename):
    ...
    print("\n==========================================")
    print("         NETSAGE AI RULE CHECKER V5")
    print("==========================================\n")
...
if __name__ == "__main__":
    process_csv(CSV_FILE)import csv
import ipaddress
import json
import re
import sys
